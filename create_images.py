...
def get_fluxes(initial_masses_Msun, metallicities, stellar_ages_yr, filter_name):
    """
    Return "fluxes" in electrons per second (as collected by the CCD),
    ...
    # Convert apparent magnitudes to "fluxes" in electrons/s. For more details,
...
def create_image_single_sub(subfind_id, pos, hsml_ckpc_h, fluxes):
    ...
    header = fits.Header()
    header["BUNIT"] = ("electrons/s/pixel", "Unit of the array values")
